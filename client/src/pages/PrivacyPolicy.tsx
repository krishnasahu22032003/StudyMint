    ...
    <div className="min-h-screen bg-bg">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 py-10 sm:py-16">
        <motion.button
          ...
          onClick={() => navigate(-1)}
          className="mb-8 inline-flex cursor-pointer items-center gap-2 rounded-xl border border-border bg-surface px-4 py-2 text-sm text-text-secondary hover:text-text-primary hover:border-accent/30 transition-all"
        >
